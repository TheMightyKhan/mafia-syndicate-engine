...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  primary:
    'bg-red-600 hover:bg-red-700 active:bg-red-800 text-white shadow-sm shadow-red-500/20 border border-red-500/30 hover:border-red-600 focus-visible:ring-red-500',
  secondary:
...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      onClick={onClick}
      style={style}
      className={`inline-flex items-center justify-center font-medium transition-all duration-200 cursor-pointer select-none outline-none focus-visible:ring-2 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-zinc-950 disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none hover:-translate-y-0.5 active:translate-y-0 ${
